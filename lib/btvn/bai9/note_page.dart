        ...
        body: BlocListener(
          ...
          */
          child: BlocBuilder<NoteCubit, NoteState>(
            // bloc: _noteCubit, là nơi để xác nhận
            bloc: _noteCubit,
            ...
            buildWhen: (context, state) {
              // ví dụ return true; thì sẽ dừng lại không chạy tiếp nữa
              // return false thì sẽ chạy tiếp đến hàm builder
